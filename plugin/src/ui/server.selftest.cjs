...
try {
  ...
  const archives = fs.readdirSync(path.join(nb, 'archive'));
  ...
  const archives2 = fs.readdirSync(path.join(nb, 'archive'));
  ...
  const archives3 = fs.readdirSync(path.join(nb, 'archive'));
